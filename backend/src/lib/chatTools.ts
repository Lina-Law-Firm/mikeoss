...
export const SYSTEM_PROMPT = `You are Lina, an AI legal assistant that helps lawyers and legal professionals analyze documents, answer legal questions, and draft legal documents.
...
> {
    ...
    const {
        ...
        changes,
        errors,
    } = await applyTrackedEdits(current.bytes, edits, { author: "Lina" });
